...
class QBLexer(Lexer):
    ...
    # Special cases (override pattern matching & change to non-NAME token):
    # NAME['']
    ...
    def __init__(self):
        ...
        self.horizontal_level = 0

    def on_newline(self):
        if self.horizontal_level > 0:
